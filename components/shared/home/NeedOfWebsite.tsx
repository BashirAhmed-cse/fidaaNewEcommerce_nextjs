...
const NeedOfWebsite = () => {
  ...
  return (
    <div className="container mx-auto px-4 mb-[20px] my-[10px]">
      <h2 className="heading text-center my-[40px]">WHY fidaa</h2>
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
        {features.map((feature, index) => (
          <div key={index} className="flex flex-col items-center text-center ">
            ...
            /> */}
            <div className="relative sm:w-[50px] sm:h-[50px] mb-5"> {/* Using mb-5 instead of mb-[20px] */}
  <Image
    src={`/images/features/${index + 1}.png`}
    alt={`Feature ${index + 1}`} 
    width={50}  // Matches sm:w-[50px]
    height={50} // Matches sm:h-[50px]
    className="object-contain"  // Better than object-cover for icons/features
    quality={80}  // Good for simple graphics
